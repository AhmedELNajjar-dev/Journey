...
export default function Header({ filters, setFilters }: HeaderProps) {
  return (
    <header className="bg-gradient-to-r from-cyan-500 to-blue-500 sticky top-0 z-50 shadow-md">
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="mt-4 flex flex-wrap gap-3 justify-center">
          ...
          >
            ...
            <option value="XS" className="text-gray-800">XS</option>
            <option value="S" className="text-gray-800">S</option>
            <option value="M" className="text-gray-800">M</option>
